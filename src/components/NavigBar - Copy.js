    ...
    <div id = "navigbar">
      <div className="flex justify-between">        
        <div className="hidden md:block">
          <div className="grid grid-flow-col place-self-center gap-32 items-baseline ">
        ...
        <div className=" md:hidden">
          <button
            ...
            type="button"
            className="items-center justify-center p-2 rounded-md text-gray-700 hover:text-white hover:bg-gray-300 focus:outline-none  "
